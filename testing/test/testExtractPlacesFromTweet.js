...
describe('ExtractPlacesFromTweet', () => {
  ...
  it('should extract "Brugata" given a tweet containing it', () => {
  ...
  it('should return "Brugata 62" if street number is in Tweet', () => {
    const tweet = new Tweet(
  ...
  it('should return "Brugata 43" if street number is in Tweet', () => {
    const tweet = new Tweet(
